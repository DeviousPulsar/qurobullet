...
void BulletType::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "linear_acceleration", PROPERTY_HINT_RANGE, "-100,100,0.01,or_less,or_greater"), "set_linear_acceleration", "get_linear_acceleration");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "curve_rate", PROPERTY_HINT_RANGE, "-360,360,0.01,or_less,or_greater"), "set_curve_rate", "get_curve_rate");
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "h_wave_amplitude", PROPERTY_HINT_RANGE, "-100,100,0.01,or_less,or_greater"), "set_h_wave_amplitude", "get_h_wave_amplitude");
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "v_wave_amplitude", PROPERTY_HINT_RANGE, "-100,100,0.01,or_less,or_greater"), "set_v_wave_amplitude", "get_v_wave_amplitude");
